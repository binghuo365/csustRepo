...
<meta http-equiv="pragma" content="no-cache" />
	...
	<meta http-equiv="refresh" content="3;url=<%=contextpath %>${returnUrl}" />
<head>
<title>系统提示 </title>
<style>
body {padding:0; margin:0; }
#infoBox{padding:0; margin:0; position:absolute; top:20%; width:100%; text-align:center;}
...
<div style='text-align:center;padding:20px 0 20px 0;margin:0 auto;width:320px;font-size:12px;background:#F5FBFF;border-right:1px #B4E0F7 solid;border-bottom:1px #B4E0F7 solid;border-left:1px #B4E0F7 solid;'>
 ${message }
 <br /><br />
        <a href="<%=contextpath %>${returnUrl }">如果您的浏览器没有自动跳转，请点击这里</a>
    </div>
</div>
</div>
</body>

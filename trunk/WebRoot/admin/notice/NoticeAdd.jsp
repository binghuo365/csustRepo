...
<div class="box-positon">
	<div class="rpos">当前位置: 公告管理 - 添加</div>
	<form class="ropt">
		<input type="submit" value="返回列表"
			onclick="this.form.action='notice_list.do';" class="return-button" />
	</form>
	<div class="clear"></div>
</div>

<div class="body-box">
<form method="post" action="notice_add.do" id="jvForm">
<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
	...
	<tr id="tr-title">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<input type="text" maxlength="150" name="title" value="<s:property value='#params.title[0]'/>" vld="{required:true}" class="required"/>
	...
	<tr id="tr-author">
		...
		<td colspan="3" width="40%" class="pn-fcontent">
			<input type="text" maxlength="100" name="author" value="<s:property value='#param.author[0]'/>" maxlength="100" />
		</td>
	</tr>
	...
	<tr id="tr-topLevel">
		...
		<td colspan="3" width="90%" class="pn-fcontent"><input
			...
			id="atime"
			style="width: 140px" name="atime" value=""> 
			<span class="pn-fhelp">留空则为当前时间</span>
		</td>
	</tr>
	
			<%--如何将页面上修改的内容通过action到数据库中？必须用Input？--%>
	<tr id="tr-txt">

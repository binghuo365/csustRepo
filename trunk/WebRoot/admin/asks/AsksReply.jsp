...
<script>
		KindEditor.ready(function(K) {
			...
			prettyPrint();
			var editor2 = K.create('textarea[name="repcontent"]', {
				cssPath : '../../thirdparty/kindeditor/plugins/code/prettify.css',
				uploadJson : '../../thirdparty/kindeditor/jsp/upload_json.jsp',
				fileManagerJson : '../../thirdparty/kindeditor/jsp/file_manager_json.jsp',
				allowFileManager : true
...
<div class="box-positon">
	<div class="rpos">当前位置: 答疑帮助 - 回复</div>
	<form class="ropt">
		<input type="submit" value="返回列表"
			onclick="this.form.action='asks_list.do';" class="return-button" />
	</form>
	<div class="clear"></div>
</div>

<div class="body-box">
<form method="post" action="asks_reply.do?id=<s:property value="id"/>&method=save" id="jvForm">
<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">

	<tr id="tr-title">
		<td width="10%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>留言标题:</td>
		<td colspan="3" width="90%" class="pn-fcontent">
			<input type="text" maxlength="50" name="title" value="<s:property value='title'/>" 
	...
	<tr id="tr-author">
		<td width="10%" class="pn-flabel pn-flabel-h">留言者:</td>
		<td colspan="3" width="40%" class="pn-fcontent">
			<input type="text" maxlength="50" name="asker" value="管理员"/>
		</td>
	</tr>
	...
	<tr id="tr-reptime">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<input class="Wdate" type="text"
				id="replytime"
				style="width: 140px" name="replytime"
				value="<s:date name='reptime' />" />
	...
	<td width="40%" class="pn-fcontent">
		<label>
			<input type="radio" value="1" 
				<s:property value='ispassed==1?"checked=checked":""' /> 
				name="ispassed"/>发布</label> 
		<label>
			<input type="radio" value="0" 
				<s:property value='ispassed==0?"checked=checked":""' /> 
				name="ispassed"/>未发布</label>
	</td>
	</tr>
	...
	<tr id="tr-repcontent">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<textarea class="ckeditor" cols="100" rows="20" id="content" 
				name="content"><s:property value="content"/></textarea>
		</td>
	</tr>
	
	<tr id="tr-author">
		<td width="10%" class="pn-flabel pn-flabel-h">回复者:</td>
		<td colspan="3" width="40%" class="pn-fcontent">
			<input type="text" maxlength="50" name="replyer" value="管理员"/>
		</td>
	</tr>
	
	<tr id="tr-repcontent">
		<td class="pn-flabel pn-flabel-h" width="10%">回复:</td>
		<td colspan="3" width="90%" class="pn-fcontent">
			<textarea class="ckeditor" cols="100" rows="20" id="repcontent" 
				name="repcontent"><s:property value="repcontent"/></textarea>
		</td>
	</tr>
	<tr-operation>

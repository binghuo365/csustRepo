...
<div class="body-box">
<form method="post" action="asks_edit.do?id=<s:property value="id"/>&method=save" id="jvForm">
<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
	...
	<td width="40%" class="pn-fcontent">
		...
		<label><input type="radio" value="0" <s:property value='ispassed==0?"checked=checked":""' /> name="ispassed"/>未发布</label>
	</td>
	</tr>	

	<tr id="tr-topLevel">
		<td colspan="1" width="10%" class="pn-flabel pn-flabel-h">留言时间:</td>
		<td colspan="3" width="90%" class="pn-fcontent">
			<input class="Wdate" type="text"
				id="releasetime"
				style="width: 140px" name="releasetime"
				value="<s:date name="releasetime" format="yyyy-MM-dd HH:mm" />" />

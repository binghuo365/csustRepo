...
<div class="box-positon">
	<div class="rpos">当前位置: 答疑帮助 - 添加</div>
	<form class="ropt">
...
<div class="body-box">
<form method="post" action="asks_add.do" id="jvForm">
<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
	...
	<tr id="tr-title">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<input type="text" maxlength="50" name="title" 
				value="<s:property value='#params.title[0]'/>" 
				class="{required:true}"/>
	...
	<tr id="tr-author">
		...
		<td colspan="3" width="40%" class="pn-fcontent">
			<input type="text" name="asker" value="管理员" maxlength="50"/>
		</td>
	</tr>
	...
	<td width="40%" class="pn-fcontent">
		<label>
			<input type="radio" value="1" 
				<s:property value='#params==null?"checked=checked":""' />  
				<s:property value='#params.ispassed[0]==1?"checked=checked":""' /> 
				name="ispassed"/>发布</label> 
		<label>
			<input type="radio" value="0" 
				<s:property value='#params.ispassed[0]==0?"checked=checked":""' /> 
	...
	<tr id="tr-addtime">
		...
		<td colspan="3" width="90%" class="pn-fcontent"><input
			...
			id="releasetime"
			style="width: 140px" name="releasetime" value="<s:property value="#params.releasetime"/>"> 
	...
	<tr id="tr-txt">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<textarea class="ckeditor" cols="100" rows="20" id="content" 
				name="content"><s:property value="#params.content"/></textarea>
		</td>
	</tr>
	...
	<tr id="tr-txt">
		...
		<td colspan="3" width="90%" class="pn-fcontent">
			<textarea class="ckeditor" cols="100" rows="20" id="repcontent" 
				name="repcontent"><s:property value="#params.repcontent"/></textarea>
		</td>
	</tr>

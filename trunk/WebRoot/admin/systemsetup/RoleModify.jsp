...
<div class="body-box">
<form method="post" action="role_update.do" id="jvForm">
...
<td colspan="4" class="pn-fbutton">
	<input type="submit" value="提交" class="submit" class="submit"/> &nbsp;
	 <input type="reset" value="重置" class="reset" onclick="javascript:window.location.href='role_edit.do?id=<s:property value='id' />'" class="reset"/>
</td>

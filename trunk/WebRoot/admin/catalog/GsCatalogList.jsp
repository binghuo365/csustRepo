...
function _gotoPage(pageNo) {
	try{
		...
		tableForm.action="gscatalog_list.do";
...
$(function(){
	...
	$("select[name='fatherid'] option").each(function(){
		if(this.value=="<s:property value='#params.fatherid[0]' />"){
...
<div class="box-positon">
	<div class="rpos">当前位置: 资源类型类别 - 列表</div>
	<div class="clear"></div>
</div>
<div class="body-box">
<form id="tableForm" action="gscatalog_list.do" method="post" style="padding-top:5px;">
...
<tr onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
	...
	<td align="center">		
	<s:if test="id>5">	
		<a href="gscatalog_edit.do?id=<s:property value="id" />" class="pn-opt">修改</a> | <a href="gscatalog_delete.do?id=<s:property value="id" />" class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}">删除</a>
	</s:if>	
	</td>
</tr>
</s:iterator>

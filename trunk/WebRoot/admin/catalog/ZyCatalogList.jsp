...
function _gotoPage(pageNo) {
	try{
		...
		tableForm.action="zycatalog_list.do";
...
<div class="box-positon">
	<div class="rpos">当前位置: 资源专业类别 - 列表</div>
	<div class="clear"></div>
</div>
<div class="body-box">
<form id="tableForm" action="zycatalog_list.do" method="post" style="padding-top:5px;">
...
<tr onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
	...
	<td align="center">
	<s:if test="id>8">	
		<a href="zycatalog_edit.do?id=<s:property value="id" />" class="pn-opt">修改</a> | 
		<a href="zycatalog_delete.do?id=<s:property value="id" />" class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}">删除</a>
	</s:if>	
	</td>
</tr>
</s:iterator>

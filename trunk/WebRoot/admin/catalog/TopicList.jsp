...
function _gotoPage(pageNo) {
	try{
		...
		tableForm.action="topic_list.do";
...
$(function(){
	...
	$("select[name='gscatalogid'] option").each(function(){
		if(this.value=="<s:property value='#params.gscatalogid[0]' />"){
	...
	$("select[name='zycatalogid'] option").each(function(){
		if(this.value=="<s:property value='#params.zycatalogid[0]' />"){
...
<div class="box-positon">
	<div class="rpos">当前位置: 专题类别 - 列表</div>
	<div class="clear"></div>
</div>
<div class="body-box">
<form id="tableForm" action="topic_list.do" method="post" style="padding-top:5px;">
<input type="hidden" name="pageNo" value=""/>
<div>

专题名称: 
<input type="text" name="title" value="<s:property value="#params.title[0]" />" style="width:70px">
所属的类型类别:
...
<tr onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
	...
	<td><s:property value="repGscatalog.name" /></td>
	<td><s:property value="repZycatalog.name" /></td>
	<td><s:property value="description" /></td>
	<td align="center">		<a href="topic_edit.do?id=<s:property value="id" />" class="pn-opt">修改</a> | <a href="topic_delete.do?id=<s:property value="id" />" class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}">删除</a></td>
</tr>
</s:iterator>

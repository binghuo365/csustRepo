...
<div class="body-box">
<form method="post" action="topic_add.do" id="jvForm">
...
<td colspan="4" class="pn-fbutton">
	<input type="submit" value="提交" class="submit" class="submit"/> &nbsp;
	 <input type="reset" value="重置" class="reset" onclick="javascript:window.location.href='topic_addui.do'" class="reset"/>
</td>

...
<iframe name="hiddenIframe" frameborder="0" border="0" style="display:none;width:0px;height:0px;"></iframe><div class="box-positon">
	<div class="rpos">当前位置: 首页 - 个人资料修改</div>
	<form class="ropt">
		<input type="submit" value="返回" onclick="this.form.action='welcome_welcome.do';" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>

<div class="body-box">
<form method="post" action="welcome_update.do" id="jvForm">
...
<input type="text" maxlength="30" class="digits" value="${sessionScope.lastloginip }" disabled="disabled" maxlength="30"/></td>

<td width="10%" class="pn-flabel pn-flabel-h">上次登录时间:</td><td colspan="1" width="40%" class="pn-fcontent">
<input type="text" maxlength="30" class="digits" value="<c:if test="${sessionScope.lastlogintime!=null }">
${fn:substring(sessionScope.lastlogintime,0,19) }
</c:if>" disabled="disabled" maxlength="30"/>
</td></tr>
...
<td colspan="4" class="pn-fbutton">
	<input type="submit" value="提交" class="submit" class="submit"/> &nbsp;
	 <input type="reset" value="重置" class="reset" onclick="javascript:window.location.href='welcome_edit.do'" class="reset"/>
</td>

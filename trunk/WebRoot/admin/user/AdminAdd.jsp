...
<div class="body-box">
<form method="post" action="admin_add.do" id="jvForm">
...
<label><input type="radio" <s:property value='#params.islock[0]==1?"checked=checked":""' /> value="1" name="islock"/>锁定</label></td>
...
<td width="10%" class="pn-flabel pn-flabel-h">教师编号:</td><td colspan="1" width="40%" class="pn-fcontent">
